...
public class All_Test_Case4 {

	@DataProvider
	public Object[][] getData() {
		// 读取测试用例的详细数据列表
		ArrayList<Object> apiCaseDetailList = ExcelUtils.readExcel("/case/test_case_04.xlsx", 0, ApiCaseDetail.class);
		// 接口的基本信息
		ArrayList<Object> apiInfoList = ExcelUtils.readExcel("/case/test_case_04.xlsx", 1, ApiInfo.class);
